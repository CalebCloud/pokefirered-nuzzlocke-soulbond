...
const u8 gText_Nuz_PlayerBlackedOutToCenter[] = _("You blacked out.\nUnder Nuzlocke rules,\nthis may end your run.\p");
const u8 gText_Nuz_PlayerBlackedOutToHome[]   = _("You blacked out.\nUnder Nuzlocke rules,\nthis may end your run.\p");
